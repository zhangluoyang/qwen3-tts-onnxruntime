...
if(DEFINED ENV{CONDA_PREFIX})
  file(GLOB _ORT_PY_DIRS "$ENV{CONDA_PREFIX}/lib/python*/site-packages/onnxruntime/capi")
  if(_ORT_PY_DIRS)
    list(SORT _ORT_PY_DIRS COMPARE NATURAL ORDER DESCENDING)
    list(GET _ORT_PY_DIRS 0 _ORT_PY_DIR)
  endif()
endif()
